...
![Volumes Creation and List](screenshots/1.png)
...
![Bind Mount Working](screenshots/2.png)
...
![App Build and Run with ENV](screenshots/3.png)
...
![Testing Environment Variables with Curl](screenshots/4.png)
...
![Docker Stats, Top, and Logs](screenshots/5.png)
...
![Network Creation and Container Attach](screenshots/6.png)
...
![Network Internal Communication via Curl](screenshots/7.png)
...
![Postgres and Redis Network Setup](screenshots/8.png)
...
![Verifying Running Services](screenshots/9.png)
...
![Docker Cleanup Output](screenshots/10.png)
